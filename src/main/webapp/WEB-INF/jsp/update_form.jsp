  ...
  <div class="info">
	...
	<div class="container mt-3">
		<div class="row">
			...
			<br>
				<h1 class="text-center mb-3">Change Book Details</h1>
				<br>
				<form action="${pageContext.request.contextPath }/update-product/${product.id }"  method="post">
				
				<input type="hidden" value="${product.id }" name="id" />
					<div class="form-group">
						<label for="name">Book Code</label> <input type="text"
							class="form-control" id="bookCode"
							name="bookCode" 
							value="${product.bookCode }" readonly>
					...
					<div class="form-group">
						<label for="name">Book Name</label> <input type="text"
							...
							name="bookName" 
							value="${product.bookName }"required>
				...
				<div class="form-group">
					...
					<div class="form-group">
						<label for="price">Book Date</label>
						<input type="text" placeholder="Enter book date"
						name="date" class="form-control" id="date" value="${product.date }" readonly>
					</div>
						<input type="hidden" 
						name="user" class="form-control" id="user" value="${product.user }" >
					<div class="container text-center">
						<a href="/user?userId=${userId} " class="btn btn-outline-danger">Back</a>
